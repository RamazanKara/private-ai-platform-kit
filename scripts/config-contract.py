...
RAG_VARS = (
    ...
    ConfigVar("RAG_RETRIEVAL_TENANT_ISOLATION_ENABLED", "retrieval_tenant_isolation_enabled", "boolean", False, "retrieval.tenantIsolation.enabled", False, "Whether retrieval is scoped to the caller's tenant (X-Sandbox-ID) via the tenant field."),
