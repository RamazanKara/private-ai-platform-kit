...
GATEWAY_VARS = (
    ...
    ConfigVar("OUTPUT_GUARDRAIL_ENABLED", "output_guardrail_enabled", "boolean", False, "guardrails.outputGuardrail.enabled", False, "Whether the response-path output guardrail inspects model completions (OWASP LLM02/LLM06)."),
