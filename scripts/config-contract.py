...
GATEWAY_VARS = (
    ...
    ConfigVar("OUTPUT_GUARDRAIL_PATTERNS", "output_guardrail_patterns", "csv", ["private_key", "github_token", "slack_token", "bearer_token", "generic_api_key_assignment", "email", "us_ssn", "credit_card"], "guardrails.outputGuardrail.patterns", ["private_key", "github_token", "slack_token", "bearer_token", "generic_api_key_assignment", "email", "us_ssn", "credit_card"], "Built-in detector names scanned on model output (credentials + PII by default)."),
