...
- Minimal: `charts/inference-gateway/values.yaml`
- Local: `clusters/local/values/inference-gateway.yaml`
- Customer: `clusters/customer/values/inference-gateway.yaml`
